...
public class ToastUtils {
     ...
     * @param args        参数数组
     */
    public static final void showToastL(Context context, int formatResId, Object... args) {
     ...
     * @param args        参数数组
     */
    public static final void showToastS(Context context, int formatResId, Object... args) {
     ...
     * @param args    参数数组
     */
    public static final void showToastL(Context context, String format, Object... args) {
     ...
     * @param args    参数数组
     */
    public static final void showToastS(Context context, String format, Object... args) {
